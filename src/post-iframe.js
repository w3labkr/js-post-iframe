(function() {
  ...
  function PostIframe(options) {
    ...
    // Callback to execute when the iframe has loaded, renamed to onComplete
    this.onComplete = typeof options.onComplete === 'function' ? options.onComplete : null;
    // Callback to execute when initialization starts, if provided
  ...
  PostIframe.prototype.initialize = function() {
    ...
    // Call the onStart callback if provided, before initialization begins
    ...
    var loadHandler = function() {
      ...
      // If an onComplete callback is provided, call it with the iframe element.
